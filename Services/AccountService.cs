...
namespace Tr3Line.Assessment.Services
{
    public interface IAccountService
    {
        ...
        Task LogOut(string email, string ipAddress);
    ...
    public class AccountService : IAccountService
    {
        ...
        public async Task LogOut(string email, string ipAddress)
        {
            var account = await _context.Accounts.SingleOrDefaultAsync(x => x.Email == email);

            // remove old refresh tokens from account
            removeAllRefreshTokens(account);
        ...
        private void removeAllRefreshTokens(Account account)
        {
